 ...
 * Reihe von statischen Methoden zur Verfügung:
 *
 ...
 * Methoden mit einem zusätzlichen Parameter color, mit der die Farbe zum
 * Zeichnen spezifiziert werden kann.
 * <p>
 * Methoden fillCircle und fillRectangle erlauben das Zeichnen von Kreisen bzw.
 * Rechtecken gefüllt mit einer bestimmten Farbe.
 * <p>
 * Die Klasse hat eine Reihe von Restriktionen, die beachtet werden sollten. Das
 * Fenster hat eine fixe Größe (standardmäßig 800 mal 600 Pixel) und erlaubt
 * kein Scrollen. Das Fenster sollte auch nicht vergrößert werden.
 *
...
public class Window {
	...
	/**
	 * Zeichnet ein Rechteck bei Position (x, y) mit Breite w und Höhe h mit
	 * Farbe color.
	 */
	...
	/**
	 * Klasse für die contentPane im WindowO Frame. Es wird paint von Component
	 * überschrieben und das BufferedImage image gezeichnet.
	 */
