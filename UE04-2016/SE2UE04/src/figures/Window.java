...
/**
 * Diese Klasse erlaubt die einfache Ausgabe von graphischen Objekten Punkt,
 ...
 * Zeichnen spezifiziert werden kann.
 * <p>
 * Methoden fillCircle und fillRectangle erlauben das Zeichnen von Kreisen bzw.
 * Rechtecken gef�llt mit einer bestimmten Farbe.
 * <p>
 * Die Klasse hat eine Reihe von Restriktionen, die beachtet werden sollten. Das
 * Fenster hat eine fixe Gr��e (standardm��ig 800 mal 600 Pixel) und
 * erlaubt kein Scrollen. Das Fenster sollte auch nicht vergr��ert werden.
 *
...
public class Window {
	...
	// Methoden für Metriken
	/** Berechnet die Breite eines Texts auf Basis der aktuellen Schriftart. **/
	...
	/** Berechnet die Höhe eines Texts auf Basis der aktuellen Schriftart. **/
	...
	/** Gibt den Text text horizontal zentriert im Punkt (x/y) aus. */
	public static void drawTextCentered(String text, int x, int y) {
		Graphics g = image.getGraphics();
		g.setColor(Color.black);
		g.drawString(text, x - getTextWidth(text) / 2, y);
		contentPane.repaint();
	}
	...
	/**
	 * Zeichnet ein gef�lltes Rechteck bei Position (x, y) mit Breite w und
	 * H�he h mit Farbe color.
	 */
	...
	/**
	 * Zeichnet einen gef�llten Kreis mit Mittelpunkt (x, y) und Radius r mit
	 * Farbe color.
	 */
	...
	/**
	 * Klasse f�r die contentPane im WindowO Frame. Es wird paint von
	 * Component �berschrieben und das BufferedImage image gezeichnet.
	 */
